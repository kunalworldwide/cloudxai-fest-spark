          ...
          <div class="booking-header">
            ...
            <div class="date-time-selector">
              <div class="selector-item">
                <p class="selector-label">select date</p>
              ...
              <div class="selector-item">
                <p class="selector-label">select time</p>
                <div class="selector-value">
            ...
            >
              <div class="ticket-card">
                ...
                <div class="ticket-card-body">
                  <h3 class="ticket-tier" v-if="ticket.tier">{{ ticket.tier.toUpperCase() }}</h3>
                  
                  <p class="ticket-description" v-if="ticket.description">{{ ticket.description }}</p>
                  
                  <!-- Perks List -->
                  <div class="ticket-perks" v-if="ticket.perks && ticket.perks.length > 0">
                    <div 
                      class="perk-item" 
